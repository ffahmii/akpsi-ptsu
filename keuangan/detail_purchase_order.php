			...
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
							...
							<div class="col-xs-12 table-responsive">
								<table class="table table-striped" id="table_order_item">
									<tbody><tr>
										<th>Nama Produk</th>
										<th>Jumlah Order</th>
										<th>Harga Per Unit<br>(Harga Dasar)</th>
										<th>Harga Per Unit<br>(Harga Penawaran)</th>
										<th>Diskon</th>
										<th>Pajak</th>
										<th>Deskripsi</th>
									</tr>
						...
						<!-- <a href="list.php"> -->
							<button type="button" id="setujuKeuangan" title="Setujui" class="btn btn-success pull-left" data-dismiss="modal">Setujui</button>
						<!-- </a> -->
						<!-- <a href="list.php"> -->
							<button type="button" id="tolakKeuangan" title="Tolak" class="btn btn-danger pull-left tolakKeuangan">Tolak</button>
						<!-- </a> -->
					</div>
					<!-- /.box-body -->
				</div>
