				...
				<form method="POST">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Tambah Permintaan Produksi Delivery Order (PPDO)</h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Cari Purchase Order</label>
								...
								<div class="col-md-2">
									<div class="form-group">
										<label>&nbsp;</label>
										<a href="#">
											<button type="button" id="button_choose_purchase_order" class="btn btn-block btn-default">Preview Detail</button>
										</a>
									</div>
									<!-- /.form-group -->
								</div>
                            ...
                            <div class="row" id="purcase_order_detail" style="display: none;">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h4>
						...
						<div class="box-footer">
							<button type="submit" name="save_purchase_order" value="submit" class="btn btn-primary">Simpan PPDO</button>
						</div>
					</div>
				</form>
				<!-- /.box -->
