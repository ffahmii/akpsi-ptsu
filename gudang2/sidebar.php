			...
			<li class="active treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
				...
				<ul class="treeview-menu">
                    ...
                    ?>
					<li class="<?php echo $currentFile === 'status-produksi-list.php' ? 'active' : ''; ?>"><a href="status-produksi-list.php"><i class="fa fa-circle-o"></i> Status Produksi</a></li>
					...
					<li class="<?php echo $currentFile === 'buat-po-bahan.php' ? 'active' : ''; ?>"><a href="buat-po-bahan.php"><i class="fa fa-circle-o"></i> PO Bahan Baku</a></li>
