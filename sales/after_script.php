...
<script>
    ...
    $('#button_add_contact_person').on('click', function() {
        $('#table_contact_person tr:last').prev().after(
            '<tr>' +
            '<td>' + $('[name="cp_nama"]').val() + '</td>' +
            '<td>' + $('[name="cp_pekerjaan"]').val() + '</td>' +
            '<td>' + $('[name="cp_email"]').val() + '</td>' +
            '<td>' + $('[name="cp_phone"]').val() + '</td>' +
            '</tr>'
        );


        $('[name="cp_nama"]').val('');
        $('[name="cp_pekerjaan"]').val('');
        $('[name="cp_email"]').val('');
        $('[name="cp_phone"]').val('');
        $('#modal_add_order_item').modal('toggle');
    });
